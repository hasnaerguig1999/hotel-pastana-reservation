...
?>
            <form class="col-4" action="" method="post" autocomplete="off">
              <label for="name" style="color:dark">room type : </label><br>
              ...
              <input class="form-control"  type="text" name="room_price" id = "username" required value=""> 
              
              
              <label class="form-label" style="color:dark" for="password">room image</label>
              <input class="form-control"  type="file" name="room_image" id = "password" required value=""> 
